...
# ── Base Packages
sudo apt install -y xorg xinit picom alacritty fish btop fzf exa bat ripgrep fastfetch feh pipewire wireplumber pipewire-pulse zram-tools variety arc-theme papirus-icon-theme tlp preload jq xclip
...
# Auto-start DWM when logging into TTY1
...
echo "🧠 Automatischer Start in DWM nach Login"
echo "⌨️ Tastaturlayout: $XKB"
echo "🎨 DWM + Tools → ~/.config/dwm/bin"
echo "⚙️ Patches & Debian-Tweaks aktivierbar über Menüs."
